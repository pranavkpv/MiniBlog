      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="hidden lg:flex flex-col space-y-8 text-white animate-in fade-in slide-in-from-left-8 duration-700">
          ...
          <p className="text-xl text-slate-400 leading-relaxed max-w-md">
            Your personal space for stories and thoughts. Log in to manage your posts with our refined, distraction-free interface.
          </p>
          
          <div className="space-y-4">
            <div className="flex items-center gap-4 text-slate-300 font-medium group">
            ...
            <div className="flex items-center gap-4 text-slate-300 font-medium">
              <div className="h-2 w-2 rounded-full bg-indigo-500 shadow-[0_0_10px_rgba(99,102,241,0.8)]" />
              <span>Fast, responsive UI with TailwindCSS.</span>
            </div>
            <div className="flex items-center gap-4 text-slate-300 font-medium">
              <div className="h-2 w-2 rounded-full bg-indigo-500 shadow-[0_0_10px_rgba(99,102,241,0.8)]" />
              <span>Elegant post management dashboard.</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 shadow-2xl rounded-3xl p-8 sm:p-12 animate-in fade-in zoom-in-95 duration-500">
          <div className="mb-10">
            ...
            <p className="mt-3 text-slate-400 font-medium">
              New to the platform?{' '}
              <Link to="/register" className="text-indigo-400 hover:text-indigo-300 underline underline-offset-4 transition">
                Create an account
              </Link>
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-5">
              {/* Email Field */}
              <div className="group">
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 ml-1 group-focus-within:text-indigo-400 transition">
                  Email Address
                </label>
                <input
                  id="email"
              ...
              <div className="group">
                <div className="flex justify-between items-center mb-2 ml-1">
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest group-focus-within:text-indigo-400 transition">
                    Password
                  </label>
                </div>
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-indigo-400 transition-colors focus:outline-none"
                  >
                    {showPassword ? (
